...
kbd_press()
{
  ...
  uint8_t character[2] = { kbd_us[keycode], 0 };
...
void
print_char(uint8_t* ch, uint8_t flags)
{
...
init_kbd()
{
  ...
  /* testps2control(); // commented out because apparently it can reset some
   * settings */
  /* testps2port(1); */
